...
export async function GET(request) {
    ...
    do {
        ...
        medicalAccs = await fetch(`https://api.geoapify.com/v2/places?categories=healthcare.clinic_or_praxis.general,healthcare.hospital&filter=circle:${longitude},${latitude},${radius}&bias=proximity:${longitude},${latitude}&limit=20&apiKey=${process.env.PLACE_API}`);
        if (!medicalAccs.ok) {
